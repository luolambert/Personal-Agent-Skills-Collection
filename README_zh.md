...
- **GitHub 导入** —— 从任意 GitHub 仓库直接导入 Skills
...
- **加载动画** —— 导入/上传操作的可视化进度反馈
- **Finder 风格浏览器** —— 以熟悉的 UI 浏览 Skill 文件结构
...
- ✨ **GitHub 导入** —— 从任意 GitHub 仓库直接导入 Skills，自动过滤无关文件
- ✨ **加载动画** —— 上传时显示圆形进度条，GitHub 导入时显示步骤进度
- ✨ **增强上传** —— 文件上传实时进度追踪
- 🐛 **回收站显示** —— 修复回收站页面项目显示问题
- 🐛 **标签更新** —— 修复 Skill 详情页标签保存问题
- 🔧 **文件浏览器** —— 优化面包屑导航和预览模态框

### v1.0.0 (2026-01)

- 🎉 初始版本发布，包含核心 Skill 管理功能
- ✨ Supabase 后端集成
- ✨ LLM 自动打标，支持多服务商
- ✨ Finder 风格文件浏览器
